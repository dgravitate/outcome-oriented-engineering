...
1. [`foundation/01-foundations-of-software-engineering.md`](foundation/01-foundations-of-software-engineering.md)  
   Explains the foundational observation behind OOE.

2. [`foundation/02-manifesto.md`](foundation/02-manifesto.md)  
   States the core commitments of Outcome-Oriented Engineering.

3. [`foundation/03-axioms.md`](foundation/03-axioms.md)  
